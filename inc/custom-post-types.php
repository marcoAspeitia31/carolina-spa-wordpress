...
function custom_slider_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Slides', 'Post Type General Name', 'carolina-spa' ),
		'singular_name'         => _x( 'Slide', 'Post Type Singular Name', 'carolina-spa' ),
		'menu_name'             => __( 'Slides Front Page', 'carolina-spa' ),
		'name_admin_bar'        => __( 'Slides', 'carolina-spa' ),
		'archives'              => __( 'Archivos Slider', 'carolina-spa' ),
		'attributes'            => __( 'Atributos del Slider', 'carolina-spa' ),
		'parent_item_colon'     => __( 'Padre Slider', 'carolina-spa' ),
		'all_items'             => __( 'Todos los slides', 'carolina-spa' ),
		'add_new_item'          => __( 'Agregar nuevo slide', 'carolina-spa' ),
		'add_new'               => __( 'Agregar nuevo Slide', 'carolina-spa' ),
		'new_item'              => __( 'Nuevo Slide', 'carolina-spa' ),
		'edit_item'             => __( 'Editar Slide', 'carolina-spa' ),
		'update_item'           => __( 'Actualizar Slide', 'carolina-spa' ),
		'view_item'             => __( 'Ver Slide', 'carolina-spa' ),
		'view_items'            => __( 'Ver Slides', 'carolina-spa' ),
		'search_items'          => __( 'Buscar Slide', 'carolina-spa' ),
		'not_found'             => __( 'Slide no encontrado', 'carolina-spa' ),
		'not_found_in_trash'    => __( 'Slide no encontrado en la basura', 'carolina-spa' ),
		'featured_image'        => __( 'Imagen destacada', 'carolina-spa' ),
		'set_featured_image'    => __( 'Agregar imagen destacada', 'carolina-spa' ),
		'remove_featured_image' => __( 'Quitar imagen destacada', 'carolina-spa' ),
		'use_featured_image'    => __( 'Usar slide como imagen destacada', 'carolina-spa' ),
		'insert_into_item'      => __( 'Insertar en slide', 'carolina-spa' ),
		'uploaded_to_this_item' => __( 'Actualizar este Slide', 'carolina-spa' ),
		'items_list'            => __( 'Lista de Slides', 'carolina-spa' ),
		'items_list_navigation' => __( 'Lista de navegación de slides', 'carolina-spa' ),
		'filter_items_list'     => __( 'Filtrar slides', 'carolina-spa' ),
	);
	$args = array(
		'label'                 => __( 'Slide', 'carolina-spa' ),
		'description'           => __( 'Images to add to the main slider in Front Page', 'carolina-spa' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		//'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
